...
# Dataset #1 - South German Credit

## About the dataset: South German Credit

This dataset is chosen because:

- It has 20 features

- It has Numerical + Categorical features

- It has labeled features

- It has 1000 samples (which is enough to separate it into train + test data)

- It has a class imbalance problem
...
Above, the best depth, learning rate, number of trees parameters are found. The depth value is 5, the learning rate value is 0.17, and number of trees is 100. 
...
78% and 74% accuracy are good enough. This may show that using Stochastic Gradient Boosting for this dataset might be suitable. Furthermore, when we look at the accuracy of the train and the test data, we see that there is no obvious difference which means there is no overfitting or underfitting. We can say that our accuracy has decreased in the test.
...
.csv and .txt files can be found in [here](https://github.com/BU-IE-582/fall20-EzgiOralBoun/tree/master/files/HW4).
